...
document.getElementById("decode").addEventListener("click", function()
{
  ...
  if (document.getElementById("dropdown").value === "Default")
  {
    ...
    else if ((versionAlg === "Default") && !(strippedVer === "\u{200C}\u{200E}\u{FEFF}\u{00AD}\u{200D}\u{FEFF}"))
    {
